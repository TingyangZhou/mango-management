...
class CreateLeaseForm(FlaskForm):
    ...
    rent = FloatField("Rent", validators=[DataRequired(), NumberRange(min=0, message="Rent must be a positive number.")])
    ...
    deposit = FloatField("Deposit", validators=[DataRequired(), NumberRange(min=0, message="Deposit must be a positive number.")])
